...
import com.jessekimani.my_finsta.LoginActivity;
import com.jessekimani.my_finsta.MainActivity;
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(photoFile==null || ivPostImage.getDrawable()==null){
                    Toast.makeText(getContext(), "No image tp showwww!!", Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void savePost(String description, ParseUser currentUser, File photoFile) {
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if(e!=null){
                    Log.e(TAG, "We ain't saving correctly sir", e);
                    Toast.makeText(getContext(), "Saving post error", Toast.LENGTH_SHORT).show();
                    return;
                }
                Log.i(TAG, "done: Saved Correctly");
